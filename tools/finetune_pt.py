...
def main():
    ...
    train_dataset = eval('dataset.'+cfg.POSETRACK.DATASET)(
        cfg, cfg.POSETRACK.ROOT, cfg.POSETRACK.TRAIN_SET, True,
        transforms.Compose([
            transforms.ToTensor(),
            normalize,
        ])
    ...
    # valid_dataset = eval('dataset.'+cfg.POSETRACK.DATASET)(
    #     cfg, cfg.POSETRACK.ROOT, cfg.POSETRACK.TRAIN_SET, False,
    #     transforms.Compose([
    #         transforms.ToTensor(),
    #         normalize,
    #     ])
    ...
    # load from COCO trained model
    coco_trained = "/private/home/keli22/HR/output/coco/pose_hrnet/coco/checkpoint.pth"
    logger.info("=> loading checkpoint '{}'".format(coco_trained))
    checkpoint = torch.load(coco_trained)
