...
def main():
    ...
    for json_path in tqdm(json_paths):
        ...
        json_file = os.path.join(args.result_path, json_path)
        annos = get_annos(json_file)  # coco format but annnotations segmented by tracks
        ...
        mmcv.dump(annos, osp.join(args.save_path, json_path))
