...
if __name__ == '__main__':
    ...
    # joint_threshold, used to ignore some of the low-confidence keypoints during OKS calculation
    # it will not cause some confidence value to become 0, nor to coordinates
