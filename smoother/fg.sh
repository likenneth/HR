# # for X in {0..9}; do sleep 4h; bash fg.sh; done
# # for X in {0..9}; do bash fg.sh; sleep 4h; done
...
# # Step 2: take CorrTrack output and infer WITH smoothing, btw take care of some bb issue
# for X in {0..127}
# do
# printf -v pdd "%03d" $X
# if squeue -u keli22 | grep infer${pdd}
